...
<html lang="en-US">
	...
	<link href="<?= assets_admin("plugins/bootstrap/css/bootstrap.min.css"); ?>" rel="stylesheet" type="text/css" />
		...
		<link href="<?= assets_admin("css/color_scheme/green.css"); ?>" rel="stylesheet" type="text/css" id="color_scheme" />
	...
	<body>
		...
		<?php include "partials/admin-aside.php" ?>
			...
			<header id="header">
               ...
               <a href="<?= site_url(); ?>"> <button type="button" class="btn btn-info btn-sm">صفحه اصلی سایت</button></a>
