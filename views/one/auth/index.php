        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-5">
                ...
                <div class="alert alert-mini alert-danger margin-bottom-30">
                    <strong> مشکل </strong>ورود اشتباه
                </div><!-- /ALERT -->

                <div class="box-static box-border-top padding-30">
                    <div class="box-title margin-bottom-30">
                        <h2 class="size-20">اگه قبلا ثبت نام کردی وارد شو</h2>
                    </div>

                    <form class="sky-form" method="post" action="<?= site_url('auth/login') ?>" autocomplete="off">
                        <div class="clearfix">
                            ...
                            <div class="form-group">
                                ...
                                <label class="input margin-bottom-10">
                                    ...
                                    <b class="tooltip tooltip-bottom-right">ایمیل خود را وارد کنید</b>
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <label class="input margin-bottom-10">
                                    ...
                                    <input type="hidden"  name="where" value="<?= $newReferer ?>">
                                    <b class="tooltip tooltip-bottom-right">رمز خود را وارد کنید</b>
                                </label>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6">
                                ...
                                <div class="form-tip pt-20">
                                    <a class="no-text-decoration size-13 margin-top-10 block" href="#">پسورد خود را فراموش کرده‌اید؟</a>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-6 text-right">
                                ...
                                <button class="btn btn-primary"><i class="fa fa-check"></i> ورود</button>
                    ...
                    <div class="text-center">
                        <div class="margin-bottom-20">&ndash; یا &ndash;</div>
                        ...
                        <a class="btn btn-block btn-social btn-twitter margin-top-10">
                            <i class="fa fa-twitter"></i> ورود با توییتر
                        </a>
            ...
            <div class="col-md-8 col-sm-7">
                ...
                <!-- ALERT -->
                <div class="alert alert-mini alert-danger margin-bottom-30">
                    <strong>مشکل </strong> پسورد و تکرار آن یکی نیستن
                </div><!-- /ALERT -->

                <div class="box-static box-transparent box-bordered padding-30">

                    <div class="box-title margin-bottom-30">
                        <h2 class="size-20">تا‌بحال اکانت نساختی؟ با فرم زیر بساز</h2>
                    </div>

                    <form class="nomargin sky-form" action="<?= site_url('auth/register') ?>" method="post" enctype="multipart/form-data">
                        <fieldset>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <label class="input margin-bottom-10">
                                            ...
                                            <b class="tooltip tooltip-bottom-right">نام خود را وارد کنید</b>
                                        </label>
                                    </div>

                                    <div class="col-md-6 col-sm-6">
                                        <label for="register:last_name">نام خانوادگی *</label>
                                        <label class="input margin-bottom-10">
                                            <i class="ico-append fa fa-user"></i>
                                            <input required="" type="text" name="lastname">
                                            <b class="tooltip tooltip-bottom-right">نام خانوادگی خود را وارد کنید</b>
                                        </label>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        ...
                                        <label class="input margin-bottom-10">
                                            ...
                                            <b class="tooltip tooltip-bottom-right">شماره تلفن خود را وارد کنید(اختیار)</b>
                                        </label>
                                    </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <label for="register:pass1">رمز عبور *</label>
                                        <label class="input margin-bottom-10">
                                            <i class="ico-append fa fa-lock"></i>
                                            <input required="" type="password" class="err" name="password">
                                            <b class="tooltip tooltip-bottom-right">حداقل ۶ کاراکتر</b>
                                        </label>
                                    </div>

                                    <div class="col-md-6 col-sm-6">
                                        <label for="register:pass2">تکرار رمز عبور *</label>
                                        <label class="input margin-bottom-10">
                                            <i class="ico-append fa fa-lock"></i>
                                            <input required="" type="password" class="err" name="rePassword">
                                            <input type="hidden"  name="where" value="<?= $newReferer ?>">
                                            <b class="tooltip tooltip-bottom-right">پسورد را دوباره وارد کنید</b>
                                        </label>
                                    </div>
                            ...
                            <label class="checkbox nomargin"><input class="checked-agree" type="checkbox" name="ghanoon"><i></i>من تمام <a href="#" data-toggle="modal" data-target="#termsModal">قوانین سایت </a> را مطالعه و قبول کردم</label>
                            <label class="checkbox nomargin"><input type="checkbox" name="news"><i></i>مرا در خبرنامه عضو کن</label>

                        </fieldset>

                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-primary"><i class="fa fa-check"></i> ثبت نام</button>
                            </div>
                        </div>
