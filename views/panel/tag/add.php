            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading panel-heading-transparent">
                        <strong>افزودن تگ</strong>
                    </div>

                    <div class="panel-body">
                    <a href="<?= admin_url('tag/list'); ?>"> <button type="button" class="btn btn-primary btn-lg margin-bottom-30">‌لیست تگ‌ها</button></a>
                        <form action="<?= admin_url('tag/save') ?>" method="post" enctype="multipart/form-data"
